...
for t in theta:
    ...
    delta_changing = ObservationLocation_changing - SourceLocation_changing    # distance between source and observation location
    E = k*Q*delta_changing/(np.linalg.norm(delta_changing))**3    # Electric field
